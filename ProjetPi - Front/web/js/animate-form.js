...
Vel = $ ? $.Velocity : Velocity,
    ...
    function(a) {
        ...
        a.fn.extend({
            openModal: function(c) {
                var e = a('<div id="lean-overlay"></div>');
                a("body").css("overflow", "hidden").append(e);
                var f = {
                        opacity: .5,
                        in_duration: 350,
                        out_duration: 250,
                    ...
                    g = d(),
                    h = a(this),
                    i = a('<div class="lean-overlay"></div>'),
                    j = ++b;
                i.attr("id", g).css("z-index", 1e3 + 2 * j), h.data("overlay-id", g).css("z-index", 1e3 + 2 * j + 1), a("body").append(i), c = a.extend(f, c), c.dismissible && (i.click(function() {
                    h.closeModal(c)
                }), a(document).on("keyup.leanModal" + g, function(a) {
                    27 === a.keyCode && h.closeModal(c)
                })), h.find(".modal-close").click(function() {
                    h.closeModal(c)
                }), i.css({
                    display: "block",
                    opacity: 0
                    ...
                    queue: !1,
                    ease: "easeOutCubic"
                }), h.data("associated-overlay", i[0]), h.hasClass("bottom-sheet") ? h.velocity({
                    bottom: "0",
                    opacity: 1
                }, {
                    duration: c.in_duration,
            ...
            closeModal: function(c) {
                var d = {
                    ...
                    f = e.data("overlay-id"),
                    g = a("#" + f);
                a("body").css("overflow", ""), e.find(".modal-close").off(), a(document).off("keyup.leanModal" + f), g.velocity({
                    opacity: 0
                }, {
                ...
                }) : e.fadeOut(c.out_duration, function() {
                    e.css({
                        top: 0
                    }), g.css({
                        display: "none"
    ...
    function(a) {
        a(document).ready(function() {
            function b(b) {
                var c = b.css("font-size");
                c && d.css("font-size", c), d.text(b.val() + "\n");
                var e = d.html().replace(/\n/g, "<br>");
                d.html(e), b.is(":visible") ? d.css("width", b.width()) : d.css("width", a(window).width() / 2), b.css("height", d.height())
            }
            ...
            a("input[autofocus]").siblings("label, i").addClass("active"), a(document).on("change", c, function() {
                ...
                var d = a(b.target);
                d.is("form") && (d.find(c).removeClass("valid").removeClass("invalid"), d.find(c).siblings("label, i").removeClass("active"), d.find("select.initialized").each(function() {
    ...
    function(a) {
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), console.log(b), this.each(function() {
                    function c(a, b) {
                    ...
                    if (-1 != i && (e = h.eq(i)), console.log(b.height), f.height(b.indicators ? b.height + 40 : b.height), g.height(b.height), h.find(".caption").each(function() {
                            c(a(this), 0)
