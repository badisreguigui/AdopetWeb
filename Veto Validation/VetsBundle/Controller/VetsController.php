...
class VetsController extends Controller
{
    ...
    public function listAction(Request $request)
    {
        ...
        $budget=$em->getRepository(TestVet::class)->idcheap();

        $budgett=$em->getRepository(Users::class)->find($budget[0]['idVeto']);
        return $this->render('VetsBundle::vets.html.twig', array('users'=>$result,'cheap'=>$budgett));
